...
from Jhonaiden import Jhonaidenmain


__CHANNEL_USERS__ = "𝐀𝐈𝐃𝐄𝐍 𝐓𝐄𝐑𝐌𝐔𝐗 𝐔𝐒𝐄𝐑"
__CHANNEL_SEVICES__ = "𝐀𝐈𝐃𝐄𝐍 𝐓𝐄𝐑𝐌𝐔𝐗 𝐒𝐄𝐑𝐕𝐈𝐂𝐄"
__CHANNEL_MENU__ = "𝐀𝐈𝐃𝐄𝐍 𝐓𝐄𝐑𝐌𝐔𝐗 𝐌𝐄𝐍𝐔"
__CHANNEL_USER__ = "𝐀𝐂𝐎𝐔𝐍𝐓 𝐃𝐀𝐓𝐀𝐈𝐋𝐒"
__CHANNEL_USERNAME__ = "𝐀𝐈𝐃𝐄𝐍 𝐓𝐄𝐑𝐌𝐔𝐗 𝐂𝐇𝐀𝐍𝐍𝐄𝐋"
__GROUP_USERNAME__   = "𝐀𝐈𝐃𝐄𝐍 𝐓𝐄𝐑𝐌𝐔𝐗 𝐓𝐎𝐎𝐋"
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if all(key in data for key in ['floats', 'localID', 'money', 'coin', "integers"]):
            ...
            print(Colorate.Horizontal(Colors.yellow_to_red, f'=======[ {__CHANNEL_USER__} ]======='))
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.yellow_to_red, f'=======[ {__CHANNEL_USERS__} ]======='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = Jhonaidenmain(acc_access_key)
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.yellow_to_red, f'=======[ {__CHANNEL_SEVICES__} ]======='))
